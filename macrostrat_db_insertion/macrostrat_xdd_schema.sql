...
ALTER VIEW macrostrat_xdd.model_run OWNER TO "xdd-writer";
...
ALTER SEQUENCE macrostrat_xdd.entity_id_seq OWNER TO "xdd-writer";
...
ALTER SEQUENCE macrostrat_xdd.entity_type_id_seq OWNER TO "xdd-writer";
...
ALTER VIEW macrostrat_xdd.latest_run_per_text OWNER TO "xdd-writer";
...
ALTER SEQUENCE macrostrat_xdd.model_run_id_seq OWNER TO "xdd-writer";
...
ALTER SEQUENCE macrostrat_xdd.relationship_id_seq OWNER TO "xdd-writer";
...
ALTER SEQUENCE macrostrat_xdd.relationship_type_id_seq OWNER TO "xdd-writer";
...
ALTER SEQUENCE macrostrat_xdd.source_text_id_seq OWNER TO "xdd-writer";
...
ALTER TABLE ONLY macrostrat_xdd.relationship
    ADD CONSTRAINT "Relationship Type Check" FOREIGN KEY (relationship_type_id) REFERENCES macrostrat_xdd.relationship_type(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY macrostrat_xdd.entity
    ADD CONSTRAINT "entity type check" FOREIGN KEY (entity_type_id) REFERENCES macrostrat_xdd.entity_type(id) ON DELETE CASCADE;
...
GRANT USAGE ON SCHEMA macrostrat_xdd TO web_anon;
GRANT USAGE ON SCHEMA macrostrat_xdd TO web_user;
